...
module.exports = CoreObject.extend({
  ...
  upload: function(options) {
    ...
    return this._determineFilePaths(options).then(function(filePaths) {
      ...
      if (manifestPath) {
        return allFilesUploaded.then(this._putObject(filePaths, manifestPath, options));
      } else {
  ...
  _putObjects: function(filePaths, options) {
    return filePaths.map(function(filePath) {
      return this._putObject(filePaths, filePath, options);
    }.bind(this));
  },

  _putObject: function(filePaths, filePath, options) {
    var plugin           = this._plugin;
    var cwd              = options.cwd;
